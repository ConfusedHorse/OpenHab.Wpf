...
{
    public class MinSecValidationRule : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            var success = validInt && Validate(validValue, 59);

            return !success
                ? new ValidationResult(false, string.Format(Properties.Resources.ValidateHourMinSec, 0, 59))
                : validationResult;
        }
